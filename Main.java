...
public class Main {
    public static void main(String[] args) {
        ...
        // Criar clientes
        clientes.add(new Customer("João Silva", "12345-000", 111122223));
        clientes.add(new Customer("Maria Souza", "54321-000", 999988887));
        ...
        for (Customer c : clientes) {
            System.out.println("Nome: " + c.getName() + ", CEP: " + c.getPostcode());
        }
